...
#define CPU_DVFS_FREQ0   (1235000)	/* KHz */
...
static unsigned int _mt_cpufreq_get_cpu_level(void)
{
...
#else
	{
		...
		case 0x49:
			return CPU_LEVEL_1;	/* 37M: 1.1G */
		case 0x4A:
		case 0x4B:
			return CPU_LEVEL_1;	/* 35M+: 1.1G */
		case 0x51:
